...
JsonPath response2 = RestAssured
        ...
        String platform2 = response2.getString("platform");
        String browser2 = response2.getString("browser");
        String device2 = response2.getString("device");
        String answer2 = "platform" + ": " + platform2 + ", " + "browser" + ": " + browser2 + ", " + "device" + ": " + device2;


        String expectedValue2 = "platform: Mobile, browser: Chrome, device: iOS";
        assertEquals(expectedValue2, answer2, "Unexpected values");
...
JsonPath response5 = RestAssured
        ...
        String platform5 = response5.getString("platform");
        String browser5 = response5.getString("browser");
        String device5 = response5.getString("device");
        String answer5 = "platform" + ": " + platform5 + ", " + "browser" + ": " + browser5 + ", " + "device" + ": " + device5;


        String expectedValue5 = "platform: Mobile, browser: No, device: iPhone";
        assertEquals(expectedValue5, answer5, "Unexpected values");
